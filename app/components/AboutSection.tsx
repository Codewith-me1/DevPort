...
//       <div className="  px-4 lg:px-8 xl:px-12  flex ">
...
export default function ScrollZoomFixed() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      /* ---------- GLOW ---------- */
      if (glowRef.current) {
        glowRef.current.style.opacity = String(0.4 + progress * 0.2);
      }
  ...
  return (
    <section ref={sectionRef} className="relative w-full overflow-hidden">
      <div className="px-4 lg:px-8 xl:px-12 flex">
        <div
          className="w-full bg-[#2E3192] rounded-[3rem]
        overflow-hidden shadow-2xl border border-white/10"
        >
          <div className="grid lg:grid-cols-2">
            {/* IMAGE SIDE */}
            <div className="relative overflow-hidden">
              <div className="relative md:h-[700px] lg:h-[600px] overflow-hidden">
                {/* ✅ GPU ZOOM LAYER */}
                <div
                  ref={zoomRef}
            ...
            {/* CONTENT */}
            <div className="p-10 lg:p-12 xl:pl-40 flex flex-col justify-center text-white">
              ...
              <p className="mt-6 text-lg text-white/90">
                So you get sharper visuals, smarter videos and relatable
                campaigns.
              </p>
